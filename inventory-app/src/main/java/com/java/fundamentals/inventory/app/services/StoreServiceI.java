...
public interface StoreServiceI {
    ...
    List<String> getStoreNamesWithMoreThanFiveCharacters();
    List<Store> findAllStoresSortedByName();
    List<Store> findAllStoresSortedById();
    Set<Store> findAllDistinctStores();
